conky.config = {
	background = true,
	color1 = "8df189", -- #8df189 subtitle
	color2 = "d8e9f7", -- #d8e9f7 text
	color3 = "10defe", -- #10defe title
	alignment = "top_left",
	own_window = true,
  ...
  own_window_class = "conky",
	...
	font1 = "JetBrainsMono Nerd Font:size=16",
	font2 = "JetBrainsMono Nerd Font:size=24",
	use_xft = true,
	update_interval = 3,
}
...
│  ${color1}${memgraph cpu10 40,310 8df189 e95420}${color2}  ${voffset -40} │
│                                         │
│                                         │
╰─────────────────────────────────────────╯
╭───────────────────────────────────╮
...
│  ${color1}${diskiograph_read nvme0ni 40,310 8df189 e95420}${color2}  ${voffset -40}│
│                                   │
│                                   │
│  ${color1}${diskiograph_read nvme0n1 40,310 8df189 e95420}${color2}  ${voffset -40}│
│                                   │
│                                   │
╰───────────────────────────────────╯
]]
